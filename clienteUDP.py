...
message = input('Digite "data" para obter data e hórario local: ')
...
print ('O servidor (\'%s\', %d) respondeu com a data local: %s' % (serverName, serverPort, modifiedMessage.decode('utf-8')))
